...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record5<Long, String, OffsetDateTime, OffsetDateTime, OffsetDateTime> {
     ...
     */
    public void setLastUpdated(@Nullable OffsetDateTime value) {
        set(2, value);
    }
    ...
    @Override
    @NotNull
    public LinkRecord values(@Nullable Long value1, @NotNull String value2, @Nullable OffsetDateTime value3, @Nullable OffsetDateTime value4, @Nullable OffsetDateTime value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    @ConstructorProperties({"id", "url", "lastUpdated", "checkedAt", "createdAt"})
    public LinkRecord(@Nullable Long id, @NotNull String url, @Nullable OffsetDateTime lastUpdated, @Nullable OffsetDateTime checkedAt, @Nullable OffsetDateTime createdAt) {
        super(Link.LINK);
