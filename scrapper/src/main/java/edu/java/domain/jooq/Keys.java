...
public class Keys {
    ...
    public static final ForeignKey<QuestionsRecord, LinkRecord> CONSTRAINT_3B = Internal.createForeignKey(Questions.QUESTIONS, DSL.name("CONSTRAINT_3B"), new TableField[] { Questions.QUESTIONS.LINK_ID }, Keys.CONSTRAINT_2, new TableField[] { Link.LINK.ID }, true);
}
