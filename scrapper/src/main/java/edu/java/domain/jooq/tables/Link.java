...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, OffsetDateTime> LAST_UPDATED = createField(DSL.name("LAST_UPDATED"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");

    /**
     * The column <code>LINK.CHECKED_AT</code>.
     */
    public final TableField<LinkRecord, OffsetDateTime> CHECKED_AT = createField(DSL.name("CHECKED_AT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function5<? super Long, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super OffsetDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function5<? super Long, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super OffsetDateTime, ? extends U> from) {
