...
public class Questions extends TableImpl<QuestionsRecord> {
     ...
     */
    public final TableField<QuestionsRecord, Integer> ANSWER_COUNT = createField(DSL.name("ANSWER_COUNT"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>QUESTIONS.LINK_ID</code>.
     */
    public final TableField<QuestionsRecord, Long> LINK_ID = createField(DSL.name("LINK_ID"), SQLDataType.BIGINT, this, "");
    ...
    public Link link() {
        if (_link == null)
            _link = new Link(this, Keys.CONSTRAINT_3B);
